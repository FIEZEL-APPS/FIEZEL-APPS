...
const index = S.buildIndex({
  grammar: JSON.parse(fs.readFileSync(path.join(__fzRoot, 'grammar-templates.json'), 'utf8')),
  vocabulary: JSON.parse(fs.readFileSync(path.join(__fzRoot, 'vocabulary-master.json'), 'utf8')),
  reading: JSON.parse(fs.readFileSync(path.join(__fzRoot, 'reading-bank.json'), 'utf8'))
});
...
const kalauTopFamily = (() => {
  const g = JSON.parse(fs.readFileSync(path.join(__fzRoot, 'grammar-templates.json'), 'utf8')).templates;
...
const wordmark = fs.readFileSync(path.join(__fzRoot, 'assets/brand/fiezel-wordmark.svg'), 'utf8');
const askIcon = fs.readFileSync(path.join(__fzRoot, 'assets/brand/fiezel-ask.svg'), 'utf8');
...
const sources = ['style.css', 'app.js', 'index.html', 'features/library/fiezel-library-ui.js',
  ...
  .map((p) => fs.readFileSync(path.join(__fzRoot, p), 'utf8')).join('\n');
