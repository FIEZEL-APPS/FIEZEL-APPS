...
// features/i18n/copy-id-*.js (himpunan literal dijaga tests/id-golden-snapshot-test.js), jadi HANYA
...
// dijaga tests/id-golden-snapshot-test.js, jadi pencariannya ikut UNION app.js + copy-id.
...
// W2-INT (pola W1-TESTPLAN 2b, harness kondisional — sama dengan tests/settings-cache-test.js):
...
setTimeout(async()=>{
 try{
  ...
  /* m025-246: jumlahnya dibaca dari aplikasi, bukan dipaku 25. Placement-lite memangkasnya
     ...
     sendiri dijaga tests/ux-redesign-test.js blok D. */
