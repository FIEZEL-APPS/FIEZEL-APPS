// tests/rollout-plan-test.js — gerbang untuk `docs/CF-ROLLOUT-PLAN.md` + `tools/flag-plan-check.mjs`.
//
...
check('Gerbang ini terdaftar di quality.yml', workflow.includes('node tests/rollout-plan-test.js'), 'quality.yml');
