/**
 * tests/cf-wiring-test.js — GERBANG pemasangan rute Worker Cloudflare (`workers/api/`).
 *
...
/* ============================================================ perakit modul ======== */
/**
 * Perakit ESM -> data URL. Berbeda dari perakit di `tests/cf-api-contract-test.js`
...
(async () => {
  ...
  check('quality.yml memanggil node tests/cf-wiring-test.js',
    quality.includes('node tests/cf-wiring-test.js'), 'quality.yml');
