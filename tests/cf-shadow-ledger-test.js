// tests/cf-shadow-ledger-test.js — gerbang untuk TELEMETRI BAYANGAN (S2).
//
...
// tests/no-network-test.js. Penyimpanan adalah objek biasa di memori.
'use strict';
...
check('Gerbang ini terdaftar di quality.yml', workflow.includes('node tests/cf-shadow-ledger-test.js'), 'quality.yml');
...
// dengan produksi. Perilaku kill switch itu sendiri diuji tests/cf-config-killswitch-test.js.
