...
/**
 * Blok sumber sebuah fungsi puncak, pola yang sama dengan tests/grammar-unlock-test.js: potong
...
function audioHarness(options) {
  ...
  const sandbox = {
    ...
    // prefetch punya gerbangnya sendiri (tests/voice-callsite-prefetch-test.js). Jumlah
  ...
  /* i18n ASLI dimuat ke sandbox sejak m025-236, meniru urutan <script> index.html
     ...
     yang salah. Pola dan sebabnya sama dengan harness i18n di tests/notification-reminder-test.js. */
  const i18nDir = path.join(__fzRoot, 'features', 'i18n');
