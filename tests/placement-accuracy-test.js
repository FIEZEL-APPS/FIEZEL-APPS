...
/**
 * tests/placement-accuracy-test.js — gerbang akurasi tes penempatan FIEZEL
 *
 ...
 *
 * Konvensi mengikuti gerbang yang sudah ada (tests/grammar-unlock-test.js, tests/level-grammar-contract-test.js):
...
// Pola kanonis repo (identik di tests/grammar-unlock-test.js dan tests/level-grammar-contract-test.js).
