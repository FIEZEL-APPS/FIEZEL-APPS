// tests/cf-shadow-mode-test.js — gerbang PERILAKU untuk sakelar transport Cloudflare.
//
// Bedanya dengan `tests/cf-transport-test.js`: berkas itu menjaga BENTUK (flag ada, default off,
...
// (`fetchMock`, didefinisikan sebelum disuntikkan) — pola yang dikenali tests/no-network-test.js.
'use strict';
...
// Buang komentar sebelum memindai (pola tests/audio-asset-pipeline-test.js:290-292).
...
check('Gerbang ini terdaftar di quality.yml', workflow.includes('node tests/cf-shadow-mode-test.js'), 'quality.yml');
...
// Perilaku kill switch itu sendiri diuji `tests/cf-config-killswitch-test.js`, dan sifat
