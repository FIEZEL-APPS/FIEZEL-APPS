/**
 * FIEZEL gerbang — tests/quota-manipulation-test.js
 *
...
(async () => {
  ...
  check('quality.yml memanggil node tests/quota-manipulation-test.js',
    quality.includes('node tests/quota-manipulation-test.js'), 'quality.yml');
