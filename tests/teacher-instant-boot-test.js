/**
 * tests/teacher-instant-boot-test.js — Gerbang uji resolusi instan guru saat splash & anti-flash dashboard murid.
 */
'use strict';
...
if (failures > 0) {
  ...
  console.log('\nALL 6 CHECKS PASSED · tests/teacher-instant-boot-test.js');
}
