 ...
 *
 * D1 ditiru dengan pola yang sama seperti tests/analytics-aggregate-test.js:
...
/* ==========================================================================
 * Tiruan D1 (pola tests/analytics-aggregate-test.js + tabel batch_dedup)
 * ========================================================================== */
function makeDb(SQL) {
  const t = {
...
/* ==========================================================================
 * Permintaan HTTP tiruan (pola tests/analytics-server-only-test.js)
 * ========================================================================== */
let ipCounter = 0;
