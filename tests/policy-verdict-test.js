#!/usr/bin/env node
/**
 * GERBANG VERDICT KEBIJAKAN (tests/policy-verdict-test.js)
 *
 * YANG DIJAGA
 * -----------
...
test('gate ini terdaftar di CI', () => {
  ...
  assert.ok(workflow.includes('node tests/policy-verdict-test.js'), 'gate yang tidak berjalan di CI bukan gate');
});
