...
/**
 * Blok sumber sebuah fungsi puncak — pola yang sama dengan tests/voice-fallback-chain-test.js:
...
(async function run() {
  ...
  check('penjaga statis: localEngine() tetap membaca prepared || ready (pagar tidak dilonggarkan)',
    ...
    'ini pagar yang sama yang dijaga tests/voice-fallback-chain-test.js');
