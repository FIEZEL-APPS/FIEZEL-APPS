// tests/cf-config-killswitch-test.js — gerbang KILL SWITCH SERVER (`GET /api/config`).
//
...
check('Gerbang ini terdaftar di quality.yml', workflow.includes('node tests/cf-config-killswitch-test.js'), 'quality.yml');
