// tests/owner-edge-guard-test.js — GERBANG penjaga jembatan edge SISI OWNER (`owner.fiezel.my.id`).
//
...
// cf-b7-testing-strategy.md §2 — sama seperti `tests/owner-dashboard-test.js`), bukan salinan logika.
//
// ==========================================================================================
...
/* ==========================================================================================
 * Fixture D1 agregat. DISALIN (bentuk ringkas) dari `tests/owner-dashboard-test.js`: gerbang ini butuh
...
(async () => {
  ...
  /* ---------- (d) artefak deployment bebas nilai secret ------------------------------- */
  {
    ...
    // diketahui — yang sudah diketahui tidak perlu dijaga. Disalin dari tests/edge-guard-test.js butir
    ...
    /* Nilai probe ini SENGAJA berbeda dari kembarannya di tests/edge-guard-test.js. Pemindai
  ...
  assert(/node tests\/owner-edge-guard-test\.js/.test(workflowSource),
    'quality.yml memanggil node tests/owner-edge-guard-test.js (gerbang yang tidak dijalankan = tidak ada)');
  assert(/node tests\/owner-dashboard-test\.js/.test(workflowSource), 'quality.yml tetap memanggil tests/owner-dashboard-test.js');
