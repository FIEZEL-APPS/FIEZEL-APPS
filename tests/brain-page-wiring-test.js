...
/**
 * GERBANG PENYAMBUNGAN OTAK KE HALAMAN (tests/brain-page-wiring-test.js) — m025-201
 *
 * ==========================================================================
 * LUBANG YANG DITUTUP
 * ==========================================================================
 * `tests/brain-manifest-test.js` sudah teliti: ia mengadu manifest dengan ISI DIREKTORI
...
test('W6 · modul off yang tidak dimuat halaman dilaporkan sebagai keputusan sadar', () => {
  ...
  // tercatat di manifest (dijamin tests/brain-manifest-test.js) dan terhitung di sini,
...
test('gate ini terdaftar di CI', () => {
  ...
  assert.ok(workflow.includes('node tests/brain-page-wiring-test.js'), 'gate yang tidak berjalan di CI bukan gate');
});
