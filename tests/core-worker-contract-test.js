...
const source=fs.readFileSync(path.join(__fzRoot,'fiezel-core-worker.js'),'utf8');
...
(async()=>{
  ...
  const libraryJson=JSON.parse(fs.readFileSync(path.join(__fzRoot,'fiezel-prompt-library.json'),'utf8'));
