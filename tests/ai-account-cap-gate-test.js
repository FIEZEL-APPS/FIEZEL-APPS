/**
 * tests/ai-account-cap-gate-test.js — GERBANG: PLAFON NEURON TINGKAT AKUN ITU WAJIB.
 *
 ...
 * data-URL lalu diimpor), sama seperti `tests/cf-wiring-test.js`.
 *
 * ==========================================================================
 ...
 *
 * Dijalankan langsung: `node tests/ai-account-cap-gate-test.js` (exit 0 = hijau).
...
function finish(extra) {
  ...
  fs.writeFileSync(path.join(root, 'reports/AI-ACCOUNT-CAP-GATE.json'), JSON.stringify(report, null, 2) + '\n');
...
/* ============================================================ perakit modul ======== */
/** Sama teknik dengan tests/cf-wiring-test.js: graf ESM -> satu data-URL yang bisa diimpor. */
