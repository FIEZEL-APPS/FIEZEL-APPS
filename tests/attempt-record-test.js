#!/usr/bin/env node
/**
 * GERBANG PROYEKSI BUKTI SINKRON (tests/attempt-record-test.js)
 *
 ...
 *   (b) AMAN — tidak ada riwayat jawaban mentah yang bisa ikut. tests/observability-privacy-test.js
...
test('gate ini terdaftar di CI', () => {
  ...
  assert.ok(workflow.includes('node tests/attempt-record-test.js'), 'gate yang tidak berjalan di CI bukan gate');
});
