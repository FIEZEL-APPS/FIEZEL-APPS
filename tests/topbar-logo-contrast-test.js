 ...
 *
 *   - tests/contrast-test.js memeriksa PASANGAN TOKEN yang sudah diketahui. Hex di dalam SVG
 *     bukan token, jadi tidak pernah ikut diperiksa.
 *   - tests/pastel-field-contrast-test.js memeriksa BIDANG yang memasang background dari token.
...
const HTML = fs.readFileSync(path.join(__fzRoot, 'index.html'), 'utf8');
