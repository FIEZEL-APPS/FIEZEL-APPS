...
/**
 * GERBANG PARITAS KEBIJAKAN INTI (tests/core-policy-parity-test.js) — m025-201
 *
 * ==========================================================================
 ...
 * tiruan (pola tests/adaptive-policy-test.js); Worker dijalankan di `vm` dengan router/KV
 * tiruan (pola tests/core-worker-contract-test.js).
 */
const fs = require('fs');
...
// ==========================================================================
// 2. app.js di dalam vm (DOM + localStorage tiruan, pola tests/adaptive-policy-test.js)
// ==========================================================================
function bootApp() {
  const store = {}, els = {};
...
test('gate ini terdaftar di CI', () => {
  ...
  assert.ok(workflow.includes('node tests/core-policy-parity-test.js'), 'gate yang tidak berjalan di CI bukan gate');
});

// tests/core-policy-parity-test.js tidak menulis satu berkas pun: laporannya adalah keluaran ini.
(async () => {
