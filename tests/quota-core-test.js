/**
 * FIEZEL gerbang — tests/quota-core-test.js
 *
...
check('quality.yml memanggil node tests/quota-core-test.js', quality.includes('node tests/quota-core-test.js'), 'quality.yml');
