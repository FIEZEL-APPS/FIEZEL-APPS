...
(function () {
  ...
  const src = fs.readFileSync(path.join(__fzRoot, 'features/neural-voice/fiezel-voice-say.js'), 'utf8');
  ...
  const chat = fs.readFileSync(path.join(__fzRoot, 'features/tutor-classroom/fiezel-tutor-voice-chat.js'), 'utf8');
  const lib = fs.readFileSync(path.join(__fzRoot, 'features/library/fiezel-library-ui.js'), 'utf8');
