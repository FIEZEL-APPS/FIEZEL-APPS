 ...
 *
 * tests/ux-flags-test.js menjaga SAKELARnya; berkas ini menjaga apa yang ada di balik sakelar itu.
...
/* ================================ G · AUDIO GAGAL ================================== */
{
  ...
  /* TIDAK ADA opsi suara peramban, di mana pun. OWNER 4 Sep 2026: "aku ga mau lagi ada
     ...
     tests/audio-locale-guard-test.js atas zona audio + app.js; asersi di bawah menutup dua
