 ...
 * Sekarang `deps: {}` dijawab 503 (diuji terpisah di `tests/ai-account-cap-gate-test.js`),
...
// Rinciannya diuji di tests/ai-response-shape-test.js; di sini yang dijaga adalah bahwa batas dan
