#!/usr/bin/env node
/**
 * tests/rate-anon-test.js — GERBANG pembatas penerbitan identitas anonim
 ...
 * Pola sama dengan tests/cf-api-contract-test.js / tests/edge-guard-test.js.
 * ======================================================================== */
...
(async () => {
   ...
   * ==================================================================== */
  {
    ...
    assert(/node tests\/rate-anon-test\.js/.test(workflow), '(h) quality.yml memanggil node tests/rate-anon-test.js');
  }
