/**
 * tests/workflow-actor-gate-test.js — GERBANG penjaga aktor untuk SEMUA workflow GitHub Actions.
 *
 ...
 * (audio/manifest.json:5). Governance-nya di docs/MASTER-ONLY-GOVERNANCE.md.
 */
...
(function main() {
  ...
  if (fs.existsSync(qualityPath)) {
    ...
    check(
      'G quality.yml memanggil node tests/workflow-actor-gate-test.js',
      quality.includes('node tests/workflow-actor-gate-test.js'),
