...
/**
 * FIEZEL gerbang — tests/r2-ux-overhaul-smoke-test.js · smoke runtime UX overhaul ronde 2
 * (IMPLEMENTATION-R2-REPORT.md). Menjalankan app.js ASLI di vm dengan DOM tiruan
 * (pola tests/p1-game-layer-smoke-test.js), lalu memeriksa perilaku yang benar-benar tampil:
 *
