/**
 * tests/edge-guard-test.js — GERBANG penjaga jembatan edge (`X-Fiezel-Edge`).
 *
 ...
 * Pola sama dengan tests/cf-api-contract-test.js (impor relatif tidak punya base di
...
(async () => {
  ...
  // (temuan K13, reports/cf-c1-konsistensi.md). Ia menjaga dirinya sendiri.
  {
    ...
    assert(/node tests\/edge-guard-test\.js/.test(workflow), 'quality.yml memanggil node tests/edge-guard-test.js');
  }
