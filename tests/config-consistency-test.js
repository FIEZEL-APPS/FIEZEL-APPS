// tests/config-consistency-test.js — gerbang KONSISTENSI KONFIGURASI: dokumen operasional vs kode,
...
check('Gerbang ini terdaftar di .github/workflows/quality.yml',
  workflow.includes('node tests/config-consistency-test.js'), 'quality.yml');
