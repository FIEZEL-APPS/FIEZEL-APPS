...
/**
 * FIEZEL gerbang — tests/settings-cache-test.js (spesifikasi reports/desain-test-baru.md §4).
 *
...
// Pola kanonis repo (tests/grammar-unlock-test.js:22, tests/level-grammar-contract-test.js:57).
...
if (clearBlock) {
  ...
  const sandbox = {
    // pola mock caches: tests/puter-auth-coop-test.js:24
    caches: {
