 ...
 *
 * Pola pemeriksaannya sama dengan tests/settings-cache-test.js: blok fungsi diekstrak dari app.js
...
check('T7b gate ini terdaftar di CI',
  /node tests\/tours-test\.js/.test(fs.readFileSync('./.github/workflows/quality.yml', 'utf8')),
