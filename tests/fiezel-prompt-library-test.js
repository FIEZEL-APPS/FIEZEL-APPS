...
const LIB=loadLibrary(path.join(__fzRoot,'fiezel-prompt-library.json'));
const expectedVersion=JSON.parse(fs.readFileSync(path.join(__fzRoot,'VERSION.json'),'utf8')).version;
let pass=0,fail=0;
