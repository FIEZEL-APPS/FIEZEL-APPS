#!/usr/bin/env node
/**
 * GERBANG SINKRON FAIL-CLOSED (tests/brain-sync-failclosed-test.js)
 *
...
test('gate ini terdaftar di CI', () => {
  ...
  assert.ok(workflow.includes('node tests/brain-sync-failclosed-test.js'), 'gate yang tidak berjalan di CI bukan gate');
});
