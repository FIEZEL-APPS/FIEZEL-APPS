...
/**
 * tests/d1-schema-contract-test.js — gerbang KONTRAK SKEMA D1 (node murni, nol dependensi,
 * nol jaringan).
 *
...
/* ================================================================================================
   ...
   Menaruh pemeriksaan ini di tests/owner-dashboard-test.js akan memaksa parser DDL KEDUA di repo yang
...
// owner ikut diubah. `tests/analytics-privacy-test.js` mengunci sisi database; ini mengunci sisi kueri.
