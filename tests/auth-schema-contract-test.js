/**
 * tests/auth-schema-contract-test.js — GERBANG kontrak SKEMA lapisan akun/peran/konten guru.
 * Pola dan alasannya sama dengan `tests/social-schema-contract-test.js`.
 *
