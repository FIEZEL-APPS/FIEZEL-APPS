#!/usr/bin/env node
/**
 * tests/content-drift-test.js â€” Pemilik: F2 (wave F, gate anti-drift konten)
 *
 * ==========================================================================
 ...
 *     (grammar-misconception-id.json): tests/misconception-diagnosis-test.js,
 ...
 *     identik: tests/misconception-taxonomy-test.js, assert "cakupan: nol yatim",
 *     "kunci map mati", "generator ... meregenerasi peta yang identik".
 *   - Cloze bank sinkron dengan grammar-templates.json:
 *     tests/cloze-bank-test.js, assert "build deterministik ... file di disk
 ...
 *     tests/grammar-curriculum-test.js. promptCount: tests/writing-rubric-test.js.
 *     counts cloze: tests/cloze-bank-test.js.
 *
 * ==========================================================================
 ...
 *      yang kehilangan penjaganya saat tests/th-coverage-test.js dikecualikan dari
...
test('E. vocabulary-th.count === jumlah entri nyata (bukti celah: tests/th-coverage-test.js keluar dari CI per 9bf2e13 â€” sejak itu TIDAK ADA gerbang CI yang membaca count ini; kelas cacat sama dengan indonesianCoverage di f87a39a)', () => {
