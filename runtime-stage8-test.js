...
// baseURI wajib ada: load() membangun URL bank dari document.baseURI (new URL(f,root)).
// Tanpa ini load() menolak diam-diam, bank kosong, dan dueItems() (yang sejak m025-141
// menyaring lewat contentLevelFor) selalu 0 - check smartReview merah bukan karena produk.
