#!/usr/bin/env node
/**
 * GERBANG IDENTITAS PERCOBAAN (attempt-identity-test.js)
 *
 * LUBANG YANG DITUTUP
 * -------------------
...
test('gate ini terdaftar di CI', () => {
  ...
  assert.ok(workflow.includes('node attempt-identity-test.js'), 'gate yang tidak berjalan di CI bukan gate');
});
