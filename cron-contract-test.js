/**
 * cron-contract-test.js — GERBANG kontrak Cron Trigger Worker `fiezel-api` (A3).
 *
...
/* ============================================================ perakit modul ======== */
/* Sama polanya dengan `cf-wiring-test.js`: path bersarang diselesaikan relatif
...
(async () => {
  ...
  /* ==================================================================== */
  {
    ...
    check('h gerbang ini terdaftar di .github/workflows/quality.yml',
      /node cron-contract-test\.js/.test(workflow));
