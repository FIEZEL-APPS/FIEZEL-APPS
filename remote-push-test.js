...
const checks={
  ...
  secretsNotRuntime:!app.includes('VAPID_PRIVATE_KEY')&&!worker.includes('VAPID_PRIVATE_KEY')&&cfg.includes("workerUrl:''")&&cfg.includes("aiGateway:'core-only'"),
...
console.log('FIEZEL remote push architecture: PASS');console.log(JSON.stringify({status:'PASS',checks,liveDeploymentConfigured:!/workerUrl:\s*''/.test(cfg)}));
