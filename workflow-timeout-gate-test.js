#!/usr/bin/env node
/**
 * GERBANG BATAS WAKTU WORKFLOW (workflow-timeout-gate-test.js)
 *
 * ==========================================================================
 ...
 *        build-number-uniqueness-test.js (perintah rusak -> hijau palsu). Jadi
 ...
 * di jalur produksi dan gerbang lain (gate-registry-test.js) sudah membaca workflow yang
