/**
 * edge-proxy-hopbyhop-test.js — GERBANG cacat F4: "permintaan ke-3 menggantung".
 *
 * ==========================================================================
 ...
 * `edge-proxy-contract-test.js`: kedua berkas MENJELASKAN nama header dan nama fungsi
 ...
 * ===================================================================== */
{
  ...
  assert(/node edge-proxy-hopbyhop-test\.js/.test(workflow),
    'quality.yml memanggil node edge-proxy-hopbyhop-test.js');
  assert(/node edge-proxy-contract-test\.js/.test(workflow),
    'quality.yml masih memanggil edge-proxy-contract-test.js (gerbang ini melengkapinya)');
}
