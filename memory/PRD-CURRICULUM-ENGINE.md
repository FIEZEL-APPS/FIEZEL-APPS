<!-- PRD ini datang dari PR #389 (mesin kurikulum). Ia BUKAN pengganti memory/PRD.md:
     berkas itu sudah lebih dulu memuat PRD redesign UI/UX FIEZEL 2.0 dan masih berlaku.
     Keduanya bertabrakan hanya karena kebetulan bernama sama; yang satu tentang tampilan,
     yang satu tentang mesin kurikulum. Dipisah, bukan salah satunya dibuang. -->
