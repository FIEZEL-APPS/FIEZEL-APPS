/**
 * role-security-test.js — GERBANG KEAMANAN lapisan peran/konten guru (§28).
 *
...
(async () => {
  ...
  for (const route of registered) {
    ...
    // diuji terpisah di auth-role-test.js.
  ...
  for (const route of registered) {
    ...
    // sandi + anti-oracle), yang diuji di auth-role-test.js. Login SENGAJA tidak
