#!/usr/bin/env node
/**
 * PHASE 0 · locale-enum-test.js — GERBANG: ENUM TERTUTUP UNTUK `locale` MURID
 *
 ...
 * dengan ai-task-contract-test.js (ai-tasks.js adalah UMD, jadi require cukup; perakit
 * data-URL cf-api-contract-test.js hanya perlu untuk graf ESM workers/api/index.js).
 *
...
// Body sah minimal (pola VALID_INPUT ai-task-contract-test.js) supaya yang diuji locale-nya,
...
// Pemeriksaan sumber (pola audio-locale-guard-test.js): route wajib melewatkan locale lewat
