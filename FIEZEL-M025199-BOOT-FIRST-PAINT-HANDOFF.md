...
lagi. Gerbang `boot-first-paint-nonblocking-test.js` menjaga separuh kedua itu.
...
- `cf-config-killswitch-test.js` assert (g) bermargin nol (`configMs>=300` atas delay 300 ms) —
