#!/usr/bin/env node
/**
 * th-bank-purity-test.js — GERBANG: KEMURNIAN BAHASA BANK SOAL DI SESI MURID THAI
 *
 * MENGAPA GERBANG INI ADA, TERPISAH DARI th-coverage-test.js. Gerbang cakupan yang lama
 ...
 *
 * Print-only; exit 1 bila ada FAIL. ENV: FIEZEL_ROOT → root repo (default __dirname).
 */
'use strict';
