// cf-client-timeout-test.js — gerbang BATAS WAKTU KLIEN di jalur Cloudflare (paket F6).
//
...
//
// Nol dependency, nol jaringan, nol berkas temporer (pola yang dikenali no-network-test.js).
'use strict';
...
assert(/node cf-client-timeout-test\.js/.test(SOURCES.workflow),
