...
(async()=>{
  ...
  // Simulate the physical-risk condition: current root navigation entry is blank.
  ...
  // Offline recovery must still use the exact current-generation index, not legacy runtime shell bytes.
