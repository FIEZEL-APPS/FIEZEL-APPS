#!/usr/bin/env node
/**
 * WAVE 4 · th-coverage-test.js — GERBANG: CAKUPAN & KEUTUHAN SELURUH KONTEN THAI
 *
...
const DOMAINS = ['core', 'app-a', 'app-b', 'app-c', 'app-d', 'feat-a', 'feat-b', 'gems', 'quota', 'settings-locale'];
