...
`continuity-test.js` menuntut `payload.preferences === undefined`. Itu benar di bawah kontrak
...
- `continuity-test.js` bertambah empat tes; `backup-ui-test.js` tetap hijau.
