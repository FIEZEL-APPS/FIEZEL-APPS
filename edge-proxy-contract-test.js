/**
 * edge-proxy-contract-test.js — GERBANG kontrak proxy PHP `deploy/edge/api-index.php`.
 *
 ...
 * cache bisa muncul di jalur beridentitas, galat mentah bisa bocor. `edge-guard-test.js`
 ...
 * ===================================================================== */
{
  ...
  assert(/node edge-proxy-contract-test\.js/.test(workflow),
    'quality.yml memanggil node edge-proxy-contract-test.js');
  assert(/node edge-guard-test\.js/.test(workflow),
    'quality.yml masih memanggil edge-guard-test.js (gerbang ini melengkapinya, bukan menggantikannya)');
}
