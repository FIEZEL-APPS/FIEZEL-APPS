// cf-live-selftest.js — pembuktian bahwa `cf-live-contract-test.js` benar-benar hidup.
//
// ==========================================================================
// MASALAH YANG DISELESAIKAN BERKAS INI
// ==========================================================================
// `cf-live-contract-test.js` menguji Worker HIDUP, dan pada paket kerja ini
...
// sama dengan `http-smoke-test.js`. Karena itu nama berkas ini masuk
// `SOCKET_ALLOWLIST` di `no-network-test.js`, dan pemindai gerbang itu diperluas
...
const GATE = path.join(__dirname, 'cf-live-contract-test.js');
