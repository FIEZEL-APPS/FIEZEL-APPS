...
// with it, so delivery is now uniform: one voice, one register. What used to be asserted
// about persona routing is asserted here as the absence of that machinery, because the
// hazard is silent regression - a reintroduced persona module, or a caller that omits the
// voice map and falls through to the adapter's {af_bella:0, af_heart:180} default where
// 'id_natural' resolves to undefined.
