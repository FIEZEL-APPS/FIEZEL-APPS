...
`grammar-quality-audit.js` serta `lesson-experience-test.js` langsung merah: inventaris soal
...
- Seluruh **83 gate** `.github/workflows/quality.yml`: PASS (82 sebelumnya + `grammar-unlock-test.js`).
- `grammar-unlock-test.js`: **16/16 PASS**. Gate ini menjalankan `lessonUnlockState()` yang asli
