...
/**
 * tools/dev/grammar-provenance-verify.js — Harness verifikasi kontrak provenance v2 (Subagent C).
 *
 * Sumber kebenaran: docs/FIX-SPEC-PROVENANCE-V2.md, bagian "Harness verifikasi (Subagent C)".
 * Kontrak entry provenance: {sourceId, sourceLevel, origin:'own'|'peer'|'taxonomy'|'fallback'}.
 *
 * C1: boot app.js via vm mengikuti pola persis tests/grammar-memory-scope-test.js.
...
/* ------------------------------------------------------------------ */
/* C1. Boot app.js — salinan setia pola tests/grammar-memory-scope-test.js  */
/* ------------------------------------------------------------------ */
const root = __fzRoot;
...
// Ikut pola tests/grammar-memory-scope-test.js: beri jalan bagi rantai load async app.js selesai
