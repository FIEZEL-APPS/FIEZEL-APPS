...
const CASES = [
  {
    ...
    gates: ['tests/tts-provider-contract-test.js']
  },
  {
  ...
  },
  {
    ...
    gates: ['tests/ai-response-shape-test.js']
  },
  {
...
const after = [];
for (const gate of ['tests/tts-provider-contract-test.js', 'tests/ai-response-shape-test.js']) {
  let code = 0;
...
fs.writeFileSync(R('reports/A12-RED-PROOF.json'), JSON.stringify(out, null, 2) + '\n');
