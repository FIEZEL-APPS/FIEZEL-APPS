/**
 * account-auth-client-test.js — GERBANG LAPIS AKUN SISI MURID.
 *
...
(async () => {
   ...
   * ----------------------------------------------------------------------- */
  {
    ...
    check('I1 gerbang ini terdaftar di quality.yml', wf.includes('node account-auth-client-test.js'), 'quality.yml');
