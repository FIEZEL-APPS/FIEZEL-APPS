...
let activeStateStorageKey=LEGACY_STATE_KEY,activeAccountUuid='',state=loadState(),V=[],R=[],G={},GRAMMAR_ITEMS=[],GRAMMAR_CURRICULUM={},GRAMMAR_CURRICULUM_INDEX=Object.create(null),WRITING_BANK=null,READING_EXAM=null;
stateReady=true;
