// release-audit-gate-test.js — gerbang yang MENJALANKAN `release-audit.py`.
//
...
// kebohongan yang lebih mahal daripada gerbang merah (`puter-popup-once-test.js:68-76`).
//
...
check('Gerbang ini terdaftar di quality.yml', workflow.includes('node release-audit-gate-test.js'), 'quality.yml');
...
if (!python) {
  ...
  // (pola placement-accuracy-test.js:96-98).
