...
Modulnya **ada**, **dimuat** `index.html`, dan unit-nya (`item-prior-test.js`) **hijau**.
...
`level-source-difficulty-variance-test.js` **menjalankan** `makeLevelSource` yang sesungguhnya
