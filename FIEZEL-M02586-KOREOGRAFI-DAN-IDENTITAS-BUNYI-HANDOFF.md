...
Kalau kamu mengubah `BEATS`, jalankan `node splash-choreography-test.js`; ia akan gagal dan
...
`splash-first-paint-test.js` menjaga ini dengan `AudioContext` tiruan yang benar-benar
...
| `splash-choreography-test.js` | menjaga seluruh invarian di atas |
| `splash-first-paint-test.js` | menjaga batas m025-84 |
