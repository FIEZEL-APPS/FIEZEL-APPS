...
assert.ok(sw.includes("const SW_REV='m025-7-"),'m025-7 diagnostic probe deploy must force a matching shell refresh while keeping the m025-5 vendor');
assert.ok(diag.includes("var DIAG_BUILD = 'm025-7';"),'diagnostics build must advance exactly to m025-7 for the device-probe deploy');
...
console.log('FIEZEL neural device hotfix m025-5 vendor / m025-7 two-chunk probe deploy: PASS');