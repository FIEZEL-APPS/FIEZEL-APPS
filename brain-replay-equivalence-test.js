#!/usr/bin/env node
/**
 * GERBANG KESETARAAN PUTAR-ULANG (brain-replay-equivalence-test.js)
 *
...
test('gate ini terdaftar di CI', () => {
  ...
  assert.ok(workflow.includes('node brain-replay-equivalence-test.js'), 'gate yang tidak berjalan di CI bukan gate');
});
