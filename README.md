...
- Grammar: 249 template / 180 lesson unik (gen2 +26 subskill baru; wave-2 +69 varian latihan) × 25 mode.
- Reading: 312 passages / 1.560 questions.
- Cloze: 210 item (gen2 +25, wave-2 +61) + alternates (cloze-alternates-v1.json).
