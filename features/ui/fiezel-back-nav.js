...
(function (root, factory) {
  ...
  function createStack(hooks) {
    ...
    function handlePop() {
      ...
      // Gerbang wajib diperiksa SEBELUM tumpukan kosong. m025-115: urutan lama memeriksa
      ...
      chained = 0;
      // m025-115: jalan buntu yang sesungguhnya - tumpukan HABIS, tidak ada lapisan yang
   ...
   *
   * m025-115. Alasan gestur tepi ini ada hanya berlaku untuk satu platform: di iOS mode
