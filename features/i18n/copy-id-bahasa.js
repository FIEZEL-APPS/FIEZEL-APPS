...
(function () {
  ...
  I18N.registerCopy('id', {
    ...
    'topbar.course-switch-aria': 'Ganti bahasa kursus',
    'topbar.course-switch-title': 'Ganti kursus (Jepang / Inggris)',
    'topbar.course-switch-active': 'Ganti Bahasa Kursus (Aktif: {aktif}, klik untuk ganti ke {tujuan})',
    'jlpt.modal-aria': 'Bank Soal Listening JLPT N5 dan N4',
    'jlpt.official-tag': '🎧 RESMI JAPAN FOUNDATION & JEES',
    'jlpt.title': 'Bank Soal Listening (Chōkai / 聴解)',
    'jlpt.subtitle': 'Simulasi Ujian Asli JLPT N5 & N4 Lengkap',
    'jlpt.close-aria': 'Tutup Panel Listening',
    'jlpt.lvl-n5': '⭐ JLPT N5 (Dasar)',
    'jlpt.lvl-n4': '🌟 JLPT N4 (Menengah)',
    'jlpt.mondai-all': 'Semua Mondai',
    'jlpt.mondai-1': 'Mondai 1: Tugas (課題)',
    'jlpt.mondai-2': 'Mondai 2: Poin (ポイント)',
    'jlpt.mondai-3': 'Mondai 3: Ungkapan (発話)',
    'jlpt.mondai-4': 'Mondai 4: Respon (即時)',
    'jlpt.download-title': '📥 Unduh Bahan Asli JLPT:',
    'jlpt.download-n5-pdf': '📄 PDF Soal N5',
    'jlpt.download-n5-script': '📝 Naskah N5',
    'jlpt.download-n4-pdf': '📄 PDF Soal N4',
    'jlpt.download-n4-script': '📝 Naskah N4',
    'jlpt.sheet-aria': 'Naskah dan Pembahasan Soal JLPT',
    'jlpt.sheet-close-aria': 'Tutup Sheet',
    'jlpt.sheet-drag-handle': 'Tarik ke bawah untuk menutup',
    'jlpt.sheet-title': 'Naskah & Pembahasan',
    'jlpt.tab-script': '📝 Naskah',
    'jlpt.tab-explain': 'Pembahasan',
    'jlpt.tab-vocab': 'Kosakata',
    'jlpt.belum-tepat': 'Belum Tepat',
    'jlpt.jawaban-benar': 'Jawabanmu Benar!',
    'jlpt.analisis-soal': 'Analisis & Penjelasan Soal:',
    'jlpt.tutup-sheet': 'Tutup Sheet',
    'jlpt.soal-sebelumnya': '◀ Soal Sebelumnya',
    'jlpt.soal-berikutnya': 'Soal Berikutnya ▶',
    'jlpt.hebat-akurat': 'Hebat, pemahaman dialogmu akurat.',
    'jlpt.kunci-pilihan': 'Kunci tepat: Pilihan {n}',
    'jlpt.lihat-kunci': 'Lihat Kunci ↗',
    'jlpt.kunci-tepat': '✓ KUNCI JAWABAN TEPAT',
    'jlpt.pilihan-nomor': 'Pilihan {n}:',
