...
(function () {
  ...
  I18N.registerCopy('th', {
    ...
    'auth.galat-layanan': 'ยังติดต่อบริการบัญชีไม่ได้ เช็กการเชื่อมต่อแล้วลองอีกครั้งนะ',
    'auth.galat-timeout': 'การเข้าสู่ระบบไม่ตอบสนอง ลองเช็กหน้าต่างเข้าสู่ระบบ หรือลองอีกครั้งนะ',
    ...
    'auth.status-menghubungkan': 'กำลังเชื่อมต่อกับ Google…',
    ...
    'auth.tombol-lanjutkan': 'ดำเนินการต่อด้วย Google',
    ...
    'auth.skip-help': 'บทเรียนและแบบฝึกหัดทั้งหมดยังใช้งานได้โดยไม่ต้องมีบัญชี — AI tutor และการซิงค์จะทำงานเมื่อลงชื่อเข้าใช้ด้วย Google',
    'auth.puter-help': 'หน้าต่างเข้าสู่ระบบ Google จะเปิดขึ้นมาชั่วครู่บน FIEZEL และปิดลงเองเมื่อเสร็จสิ้น',
    'auth.legal-note': 'เมื่อดำเนินการต่อ แสดงว่าคุณยอมรับให้บันทึกความคืบหน้าการเรียนไว้ในบัญชี Google ของคุณเอง',
    ...
    'notif.section-social': 'เพื่อน',
    'notif.invite-pending': 'มีคำเชิญเพื่อนรออยู่ — แตะเพื่อรับ',
    'notif.assignment-toast': 'งานใหม่จาก {from}: “{title}” แตะกระดิ่งเพื่อทำ',
    ...
    /* m025-365 · งานที่ครูถอน */
    'notif.tugas-ditarik': 'ครูถอนงาน “{title}” แล้ว คุณไม่ต้องทำงานนี้'
  });
}());
