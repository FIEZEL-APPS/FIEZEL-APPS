...
(function () {
  ...
  I18N.registerCopy('th', {
    ...
    'kurikulum.mapel-judul': 'วิชาอื่น ๆ — ชั้นปีที่ 1–9',
    'kurikulum.mapel-ajakan': 'คณิตศาสตร์ ภาษาอินโดนีเซีย วิชาปัญจศีล วิทยาศาสตร์และสังคมศึกษา สำหรับระยะ A–D: จุดประสงค์การเรียนรู้ 96 ข้อ สมรรถนะ 192 รายการ พร้อมสื่อการสอนและเงื่อนไขความรู้พื้นฐานที่เชื่อมระหว่างชั้นปี',
    'kurikulum.mapel-selesai': 'เพาะข้อมูลวิชาชั้นปีที่ 1–9 เรียบร้อยแล้ว',
