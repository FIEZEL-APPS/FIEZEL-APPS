...
(function () {
  ...
  I18N.registerCopy('id', {
    ...
    'notif.section-social': 'Teman',
    'notif.invite-pending': 'Undangan teman menunggu — ketuk untuk menerima.',
    'notif.assignment-toast': 'Tugas baru dari {from}: “{title}”. Ketuk lonceng untuk mengerjakan.',
