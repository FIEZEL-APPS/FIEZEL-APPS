(function (root) {
  ...
  var MAP = {
    ...
    'settings.bukti-per-murid-judul': 'Bukti belajar per murid',
    'settings.bukti-per-murid-consent': 'Saya, {nama}, mengizinkan bukti belajar saya (mastery, miskonsepsi, keputusan Braincore) disimpan dengan identitas akun saya supaya pengajar bisa membacanya khusus untuk saya. Bisa dimatikan kapan saja, dan mematikannya MENGHAPUS bukti yang sudah tersimpan.',
    'settings.bukti-per-murid-nota': 'Berbeda dari laporan agregat: yang ini bisa dibuka per orang. Yang disimpan tetap hanya ringkasan berbucket \u2014 bukan jawaban, bukan riwayat soal.',
    'settings.bukti-per-murid-aktif': 'Bukti per murid aktif. Terima kasih sudah mengizinkan.',
    'settings.bukti-per-murid-mati': 'Bukti per murid dimatikan dan yang sudah tersimpan dihapus.',
