(function (root) {
  ...
  var MAP = {
    ...
    'ai.core-brain-fiezel-belum-diaktifkan': 'Layanan AI FIEZEL belum aktif di pemasangan ini. Fitur belajar tetap bisa dipakai; yang menunggu hanya bagian AI-nya.',
    'ai.core-brain-pending-dikonfigurasi-for': 'Layanan AI FIEZEL belum siap untuk fitur ini',
    ...
    'progress.bayangan-tanpa-otoritas-unlock': '(aktif - ikut membuka prasyarat)',
    'progress.beban-dalam-sesi': 'Terasa berat atau tidak',
    ...
    'progress.belum-ada-sesi-adaptive-punya': 'Belum ada sesi yang selesai, jadi belum ada yang bisa dinilai. Selesaikan satu sesi latihan dulu.',
    ...
    'progress.lesson-terlacak-fiezel-mastery-bkt': '{tracked} lesson terlacak di \'fiezel-mastery-bkt-v1\'. Kalau bukti sudah cukup (≥95% keyakinan, ≥5 jawaban), lesson berikutnya ikut terbuka lewat jalur ini - tanpa pernah mengunci ulang yang sudah terbuka mesin lama.',
    ...
    'progress.model-memakai-agregat-perilaku-hasil': 'Yang dibaca cuma pola besarnya: seberapa rutin, secepat apa, materi apa yang rawan. Isi jawabanmu satu per satu tidak dikirim ke mana pun.',
    ...
    'progress.outcome-menjadi-evidence-policy-upcoming': 'Hasil ini dipakai untuk menyusun rencana sesi berikutnya. Isi jawabanmu tidak dikirim ke mana pun.',
    ...
    'progress.policy-bersifat-deterministik-dapat-diaudit': 'Rencana ini disusun dengan aturan tetap, bukan tebakan. Coach AI hanya menjelaskannya - ia tidak bisa mengubah rencanamu.',
    ...
    'progress.modul-menunggu-judul': 'Kesiapan & peta skill',
    'progress.modul-menunggu-isi': 'Bagian ini terisi sendiri setelah kamu menjawab soal pertama. Mulai dari tes awal atau latihan apa pun.',
    'settings.reset-lokasi-desc': 'Menghapus semua level, penguasaan materi, dan riwayat di perangkat ini. Kamu akan diminta konfirmasi dulu.',
    ...
    'progress.still-mengumpulkan-bukti-answer-terbaca': 'Masih mengenali kamu. Baru {evidence} jawaban yang terbaca - setelah polanya jelas, bagian ini ikut menentukan soalmu.',
    ...
    'progress.target-hit': 'Sesuai rencana',
    ...
    'progress.tingkat-peluang-benar': 'tingkat {targetDifficulty} - di sini kamu biasanya benar {predictedSuccess} dari 100',
    'progress.ulangan-pintar': 'Ulangan Pintar',
    'progress.vocab': 'Kosakata',
    'progress.waktu-study-dominan': 'Waktu belajar favoritmu',
