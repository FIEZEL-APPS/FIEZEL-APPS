...
(function () {
  ...
  I18N.registerCopy('th', {
    ...
    'tour.listen-once-body': 'ตรงนี้เสียงเล่นแค่ครั้งเดียว — เหมือนบทสนทนาจริง เงี่ยหูฟังดี ๆ แล้วค่อยเลือกคำตอบของคุณ',
    'tour.listen-miss-title': 'พลาดไป? ไม่เป็นไรเลย',
    'tour.listen-miss-body': 'ฟังครั้งเดียวมันท้าทายอยู่แล้ว และการพลาดก็เป็นส่วนหนึ่งของการฝึก PAW อยู่เป็นเพื่อนคุณทุกข้อ',
    ...
    // ---------- skillslab.* ----------
    'skillslab.replay-limit': 'ข้อนี้เล่นซ้ำครบจำนวนที่กำหนดแล้ว',
    'skillslab.exam-audio-once': 'เสียงข้อสอบเล่นแค่ครั้งเดียว ตอบจากโน้ตและความจำของคุณนะ',
