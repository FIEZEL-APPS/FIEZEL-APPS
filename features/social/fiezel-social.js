...
(function(root){
  ...
  var API_PATHS=Object.freeze({
    ...
    friendAdd:'/api/social/friends/add',
    friendRequests:'/api/social/friends/requests',
    friendAccept:'/api/social/friends/accept',
    friendReject:'/api/social/friends/reject',
  ...
  var api=Object.freeze({
    ...
    friendAdd:function(handle){return call(API_PATHS.friendAdd,{handle:String(handle||'').trim().replace(/^@/,'').toLowerCase()})},
    friends:function(){return call(API_PATHS.friends)},
    friendRequests:function(){return call(API_PATHS.friendRequests)},
    friendAccept:function(handle){return call(API_PATHS.friendAccept,{handle:String(handle||'').trim().replace(/^@/,'').toLowerCase()})},
    friendReject:function(handle){return call(API_PATHS.friendReject,{handle:String(handle||'').trim().replace(/^@/,'').toLowerCase()})},
