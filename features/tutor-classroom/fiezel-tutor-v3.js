...
(function (root, factory) {
  ...
  /**
   * m025-116: nama murid dibaca dari state aplikasi, bukan dipaku di naskah. Kosong berarti
  ...
  function installBrowser() {
    ...
    async function ensurePack() {
      ...
      // m025-116: bank materi menyimpan token {name}, bukan nama sungguhan. Diganti sekali
    ...
    /**
     * m025-116 (OWNER: masuk ke dalam folder lalu swipe back "malah stuck screen").
     *
