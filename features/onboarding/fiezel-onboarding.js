 ...
 * `FIEZEL_Complete_Design_Specification.pdf` bagian 3; Step 1 adalah tambahan m025-115.
 *
 ...
 *
 * m025-115 OWNER: "saat masuk tanya dulu nama mereka di onboarding (WAJIB)". Step 1 sekarang
 ...
 *    Step 1 (lihat catatan m025-115 di atas) dan mengakhiri seluruh perkenalan (bukan hanya
...
(function (root, factory) {
  ...
  var LAST_STEP = 6;
  // Step 1 (m025-115): nama murid. Langkah wajib, dan satu-satunya langkah tanpa "Lewati".
  var NAME_STEP = 1;
  ...
  // ---------------------------------------------------------------------------------------
  // Step 1 (m025-115): nama murid. WAJIB.
  //
  ...
  function show(env, options) {
    ...
    function bind() {
      try {
        ...
        // m025-115: pada langkah nama tombol ini LAHIR nonaktif lalu menyala saat murid
