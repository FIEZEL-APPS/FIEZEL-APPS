...
Diregenerasi dari baseline `main` dengan `node id-golden-snapshot-test.js --write-baseline`,
...
`id-golden-snapshot-test.js`); isi `files`/`literals`/`anchors` tidak disentuh.
