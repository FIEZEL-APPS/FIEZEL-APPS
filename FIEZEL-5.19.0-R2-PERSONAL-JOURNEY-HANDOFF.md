...
`node personal-journey-test.js` — 14 kasus: reproducibility, kontrak `now`, batas minggu WIB, target realistis, skill belum terukur, batas review, recovery (sesi terputus dan lama tidak belajar), penjelasan dari kode saja, input kosong, dan kebocoran data.

Hijau lokal juga: `pwa-cache-test.js`, `pwa-release-coherence-test.js`, `ui-structure-test.js`, `diag-panel-test.js`, `neural-voice-m028-audio-integrity-test.js`.
