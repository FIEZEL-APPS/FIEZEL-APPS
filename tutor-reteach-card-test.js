#!/usr/bin/env node
/**
 * FIEZEL m025-125 — gerbang untuk dua keputusan tutor yang sampai m025-124 hanya TERDENGAR.
 *
...
process.on('exit', () => {
  if (failures.length) {
    console.error('FIEZEL m025-125 kartu konsep + tawaran berhenti: FAIL (' + failures.length + ')');
    process.exitCode = 1;
  } else {
    console.log('FIEZEL m025-125 kartu konsep + tawaran berhenti: PASS ' + pass + '/0');
  }
});
