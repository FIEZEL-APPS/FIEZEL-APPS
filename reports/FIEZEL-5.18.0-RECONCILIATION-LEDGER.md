...
- 145 file, 123.050.589 byte; manifest checksum: `reports/FIEZEL-5.18.0-BASELINE-CHECKSUM.json`
...
- Suite penuh dijalankan dari tree ZIP: **32/32 PASS** (lihat `reports/FIEZEL-5.18.0-SUITE-RERUN-EVIDENCE.json`).
...
- `reports/FIEZEL-5.18.0-BASELINE-CHECKSUM.json` — checksum 145 file.
- `reports/FIEZEL-5.18.0-SUITE-RERUN-EVIDENCE.json` — 32/32 command PASS (exit code 0).