...
- `tests/level-grammar-contract-test.js`, `tests/grammar-curriculum-test.js`: gate baru.
...
node tests/grammar-curriculum-test.js
node grammar-quality-audit.js
node tests/level-grammar-contract-test.js
