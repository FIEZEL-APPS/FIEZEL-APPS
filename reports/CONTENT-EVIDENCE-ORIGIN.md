...
`tests/content-evidence-origin-test.js` memakai ephemeral Ed25519 key hanya untuk controlled failure probes. Test key tidak disimpan dan tidak diklaim sebagai production trust root. Production authenticity hanya boleh diklaim setelah operator memasok trust policy nyata dan signed production evidence.
