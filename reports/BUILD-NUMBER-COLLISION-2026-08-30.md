...
`tests/install-health-test.js` dan `tests/pwa-release-coherence-test.js` memeriksa keselarasan tip, dan
...
3. Nomor di bawah m025-200 **tidak boleh** dicetak ulang. Dijaga oleh
   `tests/build-number-uniqueness-test.js` (pemeriksaan monotonik).
...
`tests/build-number-uniqueness-test.js` menutup tabrakan **sebelum merge**, yaitu titik yang dulu
