...
`tests/content-adoption-evidence-test.js` menggunakan controlled synthetic aggregate evidence untuk membuktikan deterministic export/import, tamper rejection, source/candidate/config lock, whitelist privacy, bounds, count consistency, owner-boundary separation, dan canonical immutability. Proof lokal tidak mengklaim bahwa evidence tersebut berasal dari learner produksi.
