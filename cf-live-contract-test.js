// cf-live-contract-test.js — gerbang kontrak untuk Worker `fiezel-api` yang HIDUP.
//
// ==========================================================================
// KENAPA BERKAS INI ADA
// ==========================================================================
// Seluruh gerbang CF yang sudah ada (`cf-api-contract-test.js`,
// `cf-wiring-test.js`, `quota-*`, `analytics-*`, `tts-key-test.js`, ...) menguji
...
// `no-network-test.js` ikut memeriksanya.
//
// ==========================================================================
// HUBUNGAN DENGAN `no-network-test.js`
// ==========================================================================
...
// `no-network-test.js` sebagai kelas `ENV_GATED_LIVE_ALLOWLIST`, dengan syarat
...
//
// ==========================================================================
// KEBENARANNYA DIBUKTIKAN OLEH `cf-live-selftest.js`
// ==========================================================================
// Gerbang yang tidak pernah dijalankan terhadap jawaban SALAH adalah gerbang
// yang belum terbukti hidup. `cf-live-selftest.js` menyalakan server HTTP
...
const reportPath = process.env[ENV_REPORT]
  ...
  : path.join(__dirname, 'CF-LIVE-REPORT.json');
...
if (!rawBase) {
  const reason = [
    ...
    '  ' + ENV_BASE + '=https://api.fiezel.my.id node cf-live-contract-test.js --report',
...
async function run() {
  ...
  notes.push('Gerbang ini TIDAK menguji kuota 25/26, cache TTS, atau cron: ketiganya menulis state '
    + 'nyata pada database murid. Buktinya tetap di cf-wiring-test.js di atas stub, dan itu batas '
