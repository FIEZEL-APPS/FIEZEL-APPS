...
| `back-nav-test.js` | gerbang baru + gerbang lama yang mengunci mekanisme rusak diperbarui |
...
`back-nav-test.js` sekarang mengunci kontrak barunya, termasuk tiga gerbang yang menahan
