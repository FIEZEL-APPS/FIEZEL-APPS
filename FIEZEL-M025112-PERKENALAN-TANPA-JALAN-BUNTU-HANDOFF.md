...
`onboarding-test.js` sudah memeriksa tombol "Lewati" — tetapi yang diperiksanya adalah bahwa
...
| `onboarding-test.js` | empat gerbang baru, termasuk mata-mata callback |
