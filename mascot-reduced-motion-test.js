 ...
 * otomatis terdaftar oleh gate-registry-test.js.
 */
'use strict';
...
const SRC = fs.readFileSync(path.join(__dirname, 'features/mascot/fiezel-mascot.js'), 'utf8');
const CSS = fs.readFileSync(path.join(__dirname, 'features/mascot/fiezel-motion.css'), 'utf8');
