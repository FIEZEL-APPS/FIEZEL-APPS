...
const Solo = ({char, pose, motion, tint='green', height=66, bottom=14}) => (
  <AbsoluteFill>
    <Jungle tint={tint}/>
...
const Hero = () => (
  <AbsoluteFill>
    ...
    <Mascot char="nusa" pose="full-neutral" motion="idle" height={48} cx={36} bottom={15}/>
    <Mascot char="mira" pose="full-wave"    motion="wave" height={72} cx={66} bottom={15}/>
...
export const RemotionRoot = () => (
  <>
    ...
    <Composition id="MiraWave" component={Solo} durationInFrames={90} fps={FPS} width={900} height={900}
      defaultProps={{char:'mira', pose:'full-wave', motion:'wave', height:68}}/>
