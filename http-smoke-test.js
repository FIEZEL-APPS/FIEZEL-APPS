...
server.listen(0,'127.0.0.1',async()=>{
  ...
  try{
    ...
    if(grammar.version!==expectedVersion||grammar.schemaVersion!=='2.0.0'||grammar.practiceBlueprintVersion!=='focused-25-v1'||grammar.templates?.length!==139)throw new Error(`HTTP grammar payload violates the ${expectedVersion} schema contract`);
