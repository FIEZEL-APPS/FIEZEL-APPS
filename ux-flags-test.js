...
const REQUIRED = {
  ...
  todayHome: [false, "Home klasik kembali (owner 2026-09-04): hub skill pastel, bukan satu kartu"],
  fourTabNav: [false, 'Navigasi: 5 tab klasik (Home/Vocab/Grammar/Reading/Peta)'],
