...
const SW_REV='m025-95-indonesian-voice-removed-20260822-1';
...
const isNeuralAsset=request=>{const p=new URL(request.url).pathname;return p.includes('/vendor/kokoro-')||p.includes('/vendor/supertonic-3/')};
