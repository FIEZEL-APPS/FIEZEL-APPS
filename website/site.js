...
(function () {
  ...
  var hulaPaw = document.querySelector('.hero-paw.hula-paw');
  if (hulaPaw && !reduce) {
    ...
    function applyHulaRoutine(idx) {
      ...
      if (expEyesOpen) expEyesOpen.style.display = (idx === 0) ? 'block' : 'none';
      if (expEyesJoy) expEyesJoy.style.display = (idx === 1) ? 'block' : 'none';
      if (expEyesWink) expEyesWink.style.display = (idx === 2) ? 'block' : 'none';
      if (expEyesLove) expEyesLove.style.display = (idx === 3) ? 'block' : 'none';

      if (expMouthSmile) expMouthSmile.style.display = (idx === 0 || idx === 2) ? 'block' : 'none';
      if (expMouthOpen) expMouthOpen.style.display = (idx === 1 || idx === 3) ? 'block' : 'none';
    }
