...
`tests/content-adoption-test.js` membuktikan threshold, owner gate, privacy fail-closed, audit boundary, proof-fixture rejection, deterministic staging, rollback reconstruction, source-root write refusal, dan canonical source immutability. Proof menggunakan synthetic evidence dan secara eksplisit mencatat `canonicalAdoptionPerformed:false`.
