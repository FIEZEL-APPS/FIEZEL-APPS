...
| `tests/audio-asset-pipeline-test.js` | 52 gate. Menjalankan modul asli, bukan mencocokkan teks. |
...
Gate `tests/audio-asset-pipeline-test.js` **menjalankan registry** dan membandingkan jumlah kalimat
...
Pernah terjadi: dua panah di `fiezel-diag-panel.js` rusak, `tests/diag-search-test.js` mencari tombol
