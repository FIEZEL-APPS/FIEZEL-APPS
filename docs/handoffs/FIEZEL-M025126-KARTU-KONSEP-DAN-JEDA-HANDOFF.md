# FIEZEL — kartu konsep dan jeda yang benar-benar bisa diambil (handoff m025-126)
...
baru: `tests/tutor-reteach-card-test.js`.
...
## 4. Gerbang — `tests/tutor-reteach-card-test.js` (13 gate, terdaftar di `quality.yml`)
...
untuk berkas yang sama persis. (`tests/back-nav-test.js` punya persis masalah itu dan merah
