...
- **Gerbangnya struktural, bukan sopan santun.** `tests/audio-locale-guard-test.js` kini melarang
...
| `tests/voice-fallback-chain-test.js` | 53 assertion, 0 gagal (sebelumnya 28, 5 merah) |
| `tests/tts-transport-switch-test.js` | 35 assertion, 0 gagal (sebelumnya 27, 6 merah) |
