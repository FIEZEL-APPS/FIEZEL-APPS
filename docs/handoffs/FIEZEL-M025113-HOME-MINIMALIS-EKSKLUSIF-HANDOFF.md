...
`tests/contrast-test.js`, `core-config.js`, `features/neural-voice/fiezel-diag-panel.js`, `sw.js`
...
`tests/contrast-test.js` (m025-85) **sengaja** mengecualikan kombinasi tema terang + fase malam.
