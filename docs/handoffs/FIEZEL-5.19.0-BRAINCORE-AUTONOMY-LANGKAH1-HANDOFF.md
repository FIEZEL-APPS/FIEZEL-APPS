...
2. **Dua gerbang anti-drift.** `tests/brain-page-wiring-test.js` **W8**: modul berotoritas `off`
   yang punya pemanggil di `app.js` = FAIL. `tests/brain-manifest-test.js` ditulis ulang supaya
...
files_touched:
  ...
  - tests/brain-page-wiring-test.js                  # gerbang W8
  - tests/brain-manifest-test.js                     # otoritas diukur, bukan dihafal
```
