...
4. ~~Accessibility pass~~ - **SELESAI di m025-63.** Yang diperbaiki, semuanya berdasarkan pemeriksaan sumber, bukan tebakan: cincin fokus kini ada untuk tautan, kolom isian, select, textarea, dan elemen ber-tabindex (sebelumnya hanya tombol, sehingga pengguna keyboard kehilangan jejak begitu berpindah); ukuran sentuh 44px ditegaskan eksplisit, bukan kebetulan hasil padding; dan permintaan kurangi-gerak di tingkat SISTEM kini dihormati oleh perpindahan halaman - sebelumnya `startViewTransition` hanya melihat preferensi di dalam aplikasi, jadi pengguna yang sudah meminta kurangi-gerak di perangkatnya tetap mendapat animasi. Yang sudah baik dan tinggal dikunci gate: `lang="id"`, aria-label pada navigasi, toast sebagai live region, dan kontras token warna.
