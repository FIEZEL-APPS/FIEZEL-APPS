...
Kunci jawaban yang salah lebih buruk daripada tidak ada soal, jadi `tests/reading-exam-test.js`
...
- `tests/reading-exam-test.js`: **24/24 PASS**, 23 soal, 10 tipe soal.
