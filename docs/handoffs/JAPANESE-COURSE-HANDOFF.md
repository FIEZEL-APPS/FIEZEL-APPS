...
## m025-290 — kursus Jepang akhirnya sampai ke layar murid
...
**Kenapa berkas ini ikut berubah di m025-290:** ritual bump menyentuh `DIAG_BUILD` di
`features/neural-voice/fiezel-diag-panel.js`, dan A13 menuntut jejaknya tercatat. Panel
diagnostik sendiri tidak berubah perilakunya — hanya penanda buildnya naik ke m025-290.
