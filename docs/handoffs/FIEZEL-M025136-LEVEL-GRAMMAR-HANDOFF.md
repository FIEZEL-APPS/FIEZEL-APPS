...
`tests/level-grammar-contract-test.js` menemukan kata "sequence" dekat "sort". Gate-nya sekarang
...
- Seluruh 82 gate `.github/workflows/quality.yml`: PASS, termasuk dua gate baru
  `tests/grammar-curriculum-test.js` dan `tests/level-grammar-contract-test.js`.
