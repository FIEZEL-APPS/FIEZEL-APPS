...
- `tests/grammar-curriculum-test.js`: schema, inventory, order, prerequisite, level, and classroom coverage gate.
...
```text
node tests/grammar-curriculum-test.js   PASS: 12/12
