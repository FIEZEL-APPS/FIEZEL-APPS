...
`sw.js` dan `tests/cf-config-killswitch-test.js` adalah **klaim sesi A6**. Penyeberangan ini
...
disentuh, nol perilaku aset berubah, `tests/cf-config-killswitch-test.js` **tidak disentuh sama
