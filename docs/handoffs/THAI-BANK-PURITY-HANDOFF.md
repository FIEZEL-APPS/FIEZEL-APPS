...
lama `tests/th-coverage-test.js` hijau 143/143 dan tetap tidak melihatnya, karena empat permukaan
...
## Gerbang: `tests/th-bank-purity-test.js`

```
node tests/th-bank-purity-test.js
```
...
```
node tests/th-bank-purity-test.js      # 26/26 PASS
node tests/th-exam-overlay-test.js     # 13/13 PASS
...
**Penjaganya sekarang** — `tests/th-exam-overlay-test.js`, dan ia sengaja memeriksa hal yang
...
```
node tests/th-bank-purity-test.js      # 20/20 PASS
node tools/scan-th-bank-leak.js  # 0 temuan
```
...
5. **Ritual bump versi** — dinaikkan ke `m025-230`. **Tempatnya EMPAT, bukan tiga**, dan
   ...
   sekaligus. Berkas keempat itu sumber tunggalnya; `tests/coordination-guard-test.js` merah kalau
...
3. `node tests/th-bank-purity-test.js` harus tetap 26/26, `node tests/th-exam-overlay-test.js` 13/13,
