...
- Baseline proof `tests/content-promotion-test.js`: insufficient evidence HOLD, threshold PASS memicu active overlay, learning regression rollback, post-promotion regression rollback, prior runtime rollback fail closed, privacy fail closed, ledger bounded/deduplicated, dan canonical immutable.
...
- Gate wajib baru: `tests/speaking-listening-test.js`, `neural-voice-test.js`, dan `neural-voice-http-test.js`.
...
- `tests/http-smoke-test.js` expected version;
...
node tests/content-qa-agent-test.js
node tests/content-patch-gate-test.js
node tests/content-canary-test.js
node tests/content-promotion-test.js
node tests/content-adoption-test.js
node product-audit.js
node tests/runtime-stage8-test.js
node tests/ai-integration-test.js
node tests/pwa-cache-test.js
node tests/experience-integration-test.js
node tests/lesson-experience-test.js
...
- Creator Hub: `report-config.js`, `creator-report-setup.html`, `creator-report-dashboard.html`, `fiezel-report-worker.js`;
- core gate: `validator.js`, `tests/regression-test.js`, `product-audit.js`, `grammar-quality-audit.js`, `content-qa-agent.js`, `tests/content-qa-agent-test.js`, `content-patch-gate.js`, `tests/content-patch-gate-test.js`, `content-canary.js`, `content-canary-config.js`, `content-canary-config-builder.js`, `tests/content-canary-test.js`, `content-promotion.js`, `tests/content-promotion-test.js`, `content-adoption.js`, `tests/content-adoption-test.js`, `content-adoption-evidence.js`, `tests/content-adoption-evidence-test.js`, `content-evidence-origin.js`, `tests/content-evidence-origin-test.js`, `content-adoption-rehearsal.js`, `tests/content-adoption-rehearsal-test.js`, `tests/notification-reminder-test.js`, `tests/remote-push-test.js`, `tests/core-brain-test.js`, `tests/core-worker-contract-test.js`, `tests/learner-evidence-test.js`, `tests/alrs-behavior-test.js`, `tests/adaptive-policy-test.js`, `tests/policy-outcome-test.js`, `tests/pwa-cache-test.js`, `tests/http-smoke-test.js`, `tests/speaking-listening-test.js`, `neural-voice-test.js`, `neural-voice-http-test.js`;
