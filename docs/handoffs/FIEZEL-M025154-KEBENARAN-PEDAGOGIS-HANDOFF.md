...
node tests/content-integrity-gate-test.js      # gerbang runtime + kontrol positif
node tests/grammar-memory-scope-test.js        # provenance pilihan grammar
node grammar-quality-audit.js
node tests/bank-soal-audit-test.js
node tests/lesson-experience-test.js           # 139 lesson x 25 mode tetap terisi penuh
```
