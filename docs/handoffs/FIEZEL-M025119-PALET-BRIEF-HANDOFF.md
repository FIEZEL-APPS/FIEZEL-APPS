...
`index.html`, `manifest.json`, `tests/pastel-field-contrast-test.js`, `core-config.js`,
...
`tests/pastel-field-contrast-test.js` diperluas dari 6 menjadi 9 pemeriksaan. Tiga yang baru:
