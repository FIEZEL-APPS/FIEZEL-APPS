...
assert(Object.keys(G).length===GRAMMAR_DECLARED_COUNT&&Object.keys(G).length>=153,'grammar skills out of declared-count contract (m025-188: terikat count deklaratif + lantai 153)');
