#!/usr/bin/env node
/* build-number-uniqueness-test.js — GERBANG KEUNIKAN NOMOR BUILD.
 *
 ...
 * (m025-196..199, lihat BUILD-NUMBER-COLLISION-2026-08-30.md). Memeriksa seluruh riwayat
 ...
 *
 * Pakai: node build-number-uniqueness-test.js            (toleran: dasar tak terverifikasi -> lulus dengan peringatan)
 *        node build-number-uniqueness-test.js --strict   (mengikat: dasar tak terverifikasi -> MERAH; dipakai CI)
 */
